 ...
 *
 * Disassembly of SSDT.aml, Tue May 08 16:06:22 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001280 (4736)
 *     Revision         0x02
 *     Checksum         0x4B
 *     OEM ID           "MMO   "
    ...
    Scope (\_SB)
    {
        ...
        Device (LICE)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (RBUF) /* \_SB_.LICE._CRS.RBUF */
            }
            ...
            Method (_PS0, 0, NotSerialized)  // _PS0: Power State 0
            {
                DEID = Buffer (ESNL){}
                DVAL = Zero
                DEID = PGID /* \_SB_.LICE.PGID */
                If (\_SB.ABD.AVBL)
                {
                    \_SB.PEP0.FLD0 = DBUF /* \_SB_.LICE.DBUF */
                }
            }
