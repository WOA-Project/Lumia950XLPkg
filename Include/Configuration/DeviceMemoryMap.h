...
static ARM_MEMORY_REGION_DESCRIPTOR_EXTENDED gDeviceMemoryDescriptor[] = 
{
    ...
    { 0x00300000, 0x00300000, 0x00080000, ARM_MEMORY_REGION_ATTRIBUTE_UNCACHED_UNBUFFERED, AddReserved },
    { 0x00380000, 0x00380000, 0x00001000, ARM_MEMORY_REGION_ATTRIBUTE_UNCACHED_UNBUFFERED, AddReserved },
    { 0x00381000, 0x00381000, 0x00004000, ARM_MEMORY_REGION_ATTRIBUTE_UNCACHED_UNBUFFERED, AddReserved },
    { 0x00385000, 0x00385000, 0x00001000, ARM_MEMORY_REGION_ATTRIBUTE_UNCACHED_UNBUFFERED, AddReserved },
    { 0x00386000, 0x00386000, 0x00003000, ARM_MEMORY_REGION_ATTRIBUTE_UNCACHED_UNBUFFERED, AddReserved },
    { 0x00389000, 0x00389000, 0x00001000, ARM_MEMORY_REGION_ATTRIBUTE_UNCACHED_UNBUFFERED, AddReserved },
    { 0x0038A000, 0x0038A000, 0x00004000, ARM_MEMORY_REGION_ATTRIBUTE_UNCACHED_UNBUFFERED, AddReserved },
    { 0x0038E000, 0x0038E000, 0x00072000, ARM_MEMORY_REGION_ATTRIBUTE_UNCACHED_UNBUFFERED, AddReserved },
    { 0x00400000, 0x00400000, 0x00800000, ARM_MEMORY_REGION_ATTRIBUTE_WRITE_THROUGH, AddReserved },
    { 0x00C00000, 0x00C00000, 0x00040000, ARM_MEMORY_REGION_ATTRIBUTE_WRITE_BACK, AddReserved },
    { 0x00C40000, 0x00C40000, 0x00010000, ARM_MEMORY_REGION_ATTRIBUTE_WRITE_BACK, AddReserved },
    { 0x00C50000, 0x00C50000, 0x00010000, ARM_MEMORY_REGION_ATTRIBUTE_WRITE_BACK, AddReserved },
    { 0x00D00000, 0x00D00000, 0x03300000, ARM_MEMORY_REGION_ATTRIBUTE_WRITE_BACK, AddReserved },
    ...
    { 0x20000000, 0x20000000, 0x40000000, ARM_MEMORY_REGION_ATTRIBUTE_WRITE_BACK, AddMem },
    { 0x80000000, 0x80000000, 0x60000000, ARM_MEMORY_REGION_ATTRIBUTE_WRITE_BACK, AddMem },
